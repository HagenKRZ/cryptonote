...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1fa391;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(14886000000000000000000);
...
const char     CRYPTONOTE_NAME[]                             = "redpillfinance";
